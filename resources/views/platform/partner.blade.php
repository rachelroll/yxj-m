    ...
    <div id="ea_c">
        <div id="n_content_left_t" class="n_content_left_t">
            <span id="n_content_left_t1" class="n_content_left_t1">
                <span id='xn_c_75_newstypename'>合作伙伴</span>
            </span>
            <span class="n_content_left_t2">
                <span id='xn_c_75_newsename'>Cooperative partner</span>
            </span>
        </div>
        <div id="xn_mc_about_1_wrap" class="xn_mc_about_1_wrap">
            ...
            <ul class="xn_mc_about_1_ul">
                <li class="xn_mc_about_1_li @if(request()->fullUrl() == route('platform-partner')) xn_mc_about_1_curr @endif">
