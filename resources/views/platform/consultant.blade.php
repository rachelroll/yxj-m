    ...
    <div id="ea_ba">
        <div class="about_banner" id="about_banner"     >
            <div class="about_banner_m">
                <img  data-original="/img/PlantForm.jpg" alt="" />
            </div>
        </div>
    </div>
    ...
    <div id="ea_c">
        <div id="n_content_left_t" class="n_content_left_t">
            <span id="n_content_left_t1" class="n_content_left_t1">
                <span id='xn_c_75_newstypename'>资助顾问</span>
            </span>
            <span class="n_content_left_t2">
                <span id='xn_c_75_newsename'>Financial adviser</span>
            </span>
        </div>
        <div id="xn_mc_about_1_wrap" class="xn_mc_about_1_wrap">
            <ul class="xn_mc_about_1_ul">
                <li class="xn_mc_about_1_li" @if(request()->fullUrl() != route('platform-committee')) style="background-color: white;"  @endif>
                    <a href="{{ route('platform-committee') }}" @if(request()->fullUrl() != route('platform-committee')) style="color: rgb(127, 127, 127);"  @endif>
                        项目决策委员会
                    </a>
                </li>
            ...
            <ul class="xn_mc_about_1_ul">
                ...
                <li class="xn_mc_about_1_li @if(request()->fullUrl() == route('platform-consultant')) xn_mc_about_1_curr @endif">
        ...
        <div id="xn_c_products_2_warp" class="xn_c_products_2_warp">
            <div class="xn_c_products_2_text">
                ...
                <ul>
                    ...
                    <li>国家发展改革委规划司召开 2019年全国特色小镇现场经验交流会</li>
                    <li>人民大学教授遇上乡村小乡村！12天，焕然一新！</li>
                    <li>“艺乡建”云南联合研究基地正式成立</li>
                    <li>神农架远山儿童村项目北京座谈会</li>
                    <li>小芝麻 大乾坤“乡村振兴背景下芝麻产业发展模式研究”研讨会</li>
